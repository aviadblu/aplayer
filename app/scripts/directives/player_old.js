      ...
      controller: function ($scope, $element, $attrs) {
        ...
        $scope.actions = {
          ...
          init: function() {
            ...
            $scope.actions.setTrack($scope.currTrack);
          ...
          play_pause: function() {
            ...
            if($scope.player_data.playing) {
              $scope.player_data.playing = false;
              $scope.player[playing_player].pauseVideo();
            }
            else {
              $scope.player_data.playing = true;
              $scope.player[playing_player].playVideo();
            }
          ...
          setTrack: function(index, autoplay) {
            ...
            $scope.player_data.current_track = $scope.tracks[$scope.currTrack].name;

            $scope.player_data.next_track = $scope.tracks[$scope.currTrack + 1].name;
