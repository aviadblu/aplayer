...
.directive('youtubeVideo', ['youtubeEmbedUtils', function (youtubeEmbedUtils) {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            var eventorName = scope.eventorName + "." || eventPrefix;

            console.log(eventorName + " event created");
            ...
            function onPlayerStateChange (event) {
                //console.log("state changed for " + eventorName);
                var state = stateNames[event.data];
                if (typeof state !== 'undefined') {
                    applyBroadcast(eventorName + state, scope.player, event);
                }
                scope.$apply(function () {
            ...
            function onPlayerReady (event) {
                applyBroadcast(eventorName + 'ready', scope.player, event);
            }
